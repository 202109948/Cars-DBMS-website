...
$pk = getPrimaryKeyColumn($conn, "orders");
$options = getReferenceTableOptions($conn, "orders");
    ...
    if (isset($_POST['oid']) && !empty($_POST['oid'])) {
        ...
        if ($validData) {
            ...
            if ($conn->affected_rows > 0) {
                ...
                echo "No records updated. The order id you entered does not exist.";
            }
        } else {
            echo "Invalid data provided.";
        }
    } else {
        echo "The order id is not set";
    }
} else {
